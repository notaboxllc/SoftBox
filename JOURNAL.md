...
**Next: Phase 1.5** — determine the v1 crosslinked-bundle setup cost (existing config vs authoring; /tmp scratch, byte-clean) → proceed to Phase 2 (running-v1 plateau, aggregate-within-SEM) or STOP+report if invasive. Report: `INC5A_CROSSLINKER_FINDINGS.md` (§5c-iii Phase 1 appended).
