...
OUT=/home/jba/Code/SoftBox/RUN_LOGS/motor_audit/campaigns_2026-08/TWIRL_REPRO_GPU
...
say "TWIRL REPRODUCTION (GPU) — d$DENS, target ${TARGET} um, lawn ${MX}x${MY}, dt $DT, cap $STEPS steps"
say "  NATIVE x3 vs MIRROR x3, 3 sequential matched PAIRS (2 concurrent), ~22 h"
