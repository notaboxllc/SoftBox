...
LAWN=${LAWN:-20260901}
BASE="-run -gpu -devicecull -nohires -noviz -density 200 -matx 24.0 -maty 2.0 -filx 2.5 -eta 0.01 -dt 1.25e-7 -steps $STEPS -target 10.0 -filsegs 1 -triad -convaz-nocomp"
